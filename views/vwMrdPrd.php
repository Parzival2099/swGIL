<div class="bx-pr-art-sg">
        <h5>Algunos Productos Similares</h5>
        <div class="row bx-art-sg">
            ...
            <section class="section col d-flex gap-5 align-items-center bx-mr-prd">
                <div class="col-2"></div>
                <div class="col-2"></div>
                <div class="col-2"></div>
                <div class="col-2"></div>
            ...
            <button class="btn-direct" id="btn-right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
